...
HTTP_HEADERS_POST = { "Content-Type" : "application/json", "Accept" : "application/json" }
HTTP_HEADERS_GET = { 'Content-Type' : 'application/json', "Accept" : "application/json" }
...
def vep_post(
	...
	common.check_num_None(1, (vcfspec_list, hgvsg_list), ('vcfspec_list', 'hgvsg_list'))
	common.check_arg_choices(refver, 'refver', REFVERS_ALLOWED)
