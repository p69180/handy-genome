...
def draw_bars_sbs(ax, catalogue_dict, title, ylim, catalogue_keys_sbs96, 
    ...
    for idx, key in enumerate(catalogue_keys_sbs96):
        ...
        color = misc.COLORS_SBS6[f'{ref}>{alt}']
...
def draw_pie_sbs6(ax, catalogue_dict_sbs6, catalogue_keys_sbs6):
    ...
    colors = [misc.COLORS_SBS6[k] for k in catalogue_keys_sbs6]
...
def main(sigresult, sampleid):
    ...
    # get catalogue keys
    catalogue_keys_sbs96 = misc.create_catalogue_keys_sbs96(as_tuple=False)
    catalogue_keys_sbs6 = misc.create_catalogue_keys_sbs6(as_tuple=False)
